...
void ScoreBoard::update() {
    ...
    _lcd->setCursor(1,1);
    _lcd->print( "Points:" + String( _player1->getPoints()) +  "  Points:" + String( _player2->getPoints()) );
    _lcd->setCursor(1,2);
    _lcd->print( "Games :" + String( _player1->getGames()) +  "  Games :" + String( _player2->getGames()) );
    _lcd->setCursor(1,3);
    _lcd->print( "Sets  :" + String( _player1->getSets()) +  "  Sets  :" + String( _player2->getSets()) );
