...
TranslateConstant::TranslateConstant() {
    ...
    _digital_mode_to_string  = {
        {  0, "LOW"             },
        {  1, "HIGH"            }}; }

TranslateConstant::~TranslateConstant(){}

String TranslateConstant::get_translated_constant( int the_constant ) {
    return _map_constant_to_string[ the_constant ];
}

String TranslateConstant::get_translated_digital_mode( int the_constant ) {
